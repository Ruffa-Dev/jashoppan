...
function Accueil() {
  ...
  function getHomeProducts() {
    ...
    fetch("https://localhost:4000/home?category=mangas", options)
      .then((response) => {
    ...
    fetch("https://localhost:4000/home?category=videoGames", options)
      .then((response) => {
        return response.json();
      })
      .then(
    ...
    fetch("https://localhost:4000/home?category=goodies", options)
      .then((response) => {
        return response.json();
      })
      .then(
